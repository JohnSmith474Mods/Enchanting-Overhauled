...
public class Config {
    ...
    public static final PropertyGroup GROUP_ENCHANTMENT_DAMAGE_CALCULATION = TAB_GENERAL.registerGroup("damage_calculation");
    ...
    public static final Property.Bounded<Integer> BOUNDED_SCROLL_STEP = GROUP_ENCHANTING_TABLE.register(
            new Property.Bounded<>("scroll_step", "How many enchantments are skipped when pressing the navigation buttons.", GROUP_ENCHANTING_TABLE, 3, 1, 3, Codec.INT)
    );
    // endregion
    ...
    public static final Property.Binary BINARY_OVERRIDE_ENCHANTMENT_MAX_LEVEL = GROUP_ENCHANTMENT_GENERAL.register(
            new Property.Binary("override_enchantment_max_level", "Whether the max level of scalable enchantments should be overridden by the \"enchantment_max_level\" value.", GROUP_ENCHANTMENT_GENERAL, true)
    );
    ...
    public static final Property.Bounded<Integer> BOUNDED_MAX_ENCHANTMENT_AMOUNT = GROUP_ENCHANTMENT_GENERAL.register(
            new Property.Bounded<>("max_enchantment_amount", "The maximum amount of enchantments an Item can entertain.", GROUP_ENCHANTMENT_GENERAL, 3, 1, Integer.MAX_VALUE, Codec.INT)
    );
    public static final Property.Binary BINARY_TOMES_HAVE_GREATER_ENCHANTMENTS = GROUP_ENCHANTMENT_GENERAL.register(
    ...
    // region Enchantment Tooltip
    public static final Property.Binary BINARY_ENABLE_ENCHANTMENT_TOOLTIP_MODIFICATIONS = GROUP_ENCHANTMENT_TOOLTIP.register(
            new Property.Binary("enable_tooltip_modifications", "Whether Enchanting Overhauled is allowed to change the appearance of enchantment tooltips in any way, shape or form.", GROUP_ENCHANTMENT_TOOLTIP, true)
    );
    public static final Property.Binary BINARY_COLOR_ENCHANTMENT_NAME_BY_THEME = GROUP_ENCHANTMENT_TOOLTIP.register(
            new Property.Binary("name_color_modifications", "Whether the enchantment name coloring modifications should be applied or not.", GROUP_ENCHANTMENT_TOOLTIP, true)
    );
    public static final Property.Binary BINARY_COLOR_ENCHANTMENT_LEVEL_BY_LEVEL = GROUP_ENCHANTMENT_TOOLTIP.register(
            new Property.Binary("level_color_modifications", "Whether the enchantment level coloring modifications should be applied or not.", GROUP_ENCHANTMENT_TOOLTIP, true)
    );
    ...
    public static final Property.Binary BINARY_SHOW_TOOLTIP_ENCHANTMENT_DESCRIPTIONS = GROUP_ENCHANTMENT_TOOLTIP.register(
            new Property.Binary("show_tooltip_enchantment_descriptions", "Whether enchantments descriptions should be displayed on the items tooltip.", GROUP_ENCHANTMENT_TOOLTIP, true)
    );
    public static final Property.Binary BINARY_SHOW_TABLE_ENCHANTMENT_DESCRIPTIONS = GROUP_ENCHANTMENT_TOOLTIP.register(
            new Property.Binary("show_table_enchantment_descriptions", "Whether enchantments descriptions should displayed on the enchantment slot's tooltip.", GROUP_ENCHANTMENT_TOOLTIP, true)
    );
    // endregion

    // region XP Values
    public static final Property.Binary BINARY_ENABLE_XP_MODIFICATIONS = GROUP_XP_GENERAL.register(
            new Property.Binary("enable_xp_and_level_modifications", "Whether the XP requirement formula changes are applied or not.", GROUP_XP_GENERAL, true)
    );
    ...
    public static final Property.Binary BINARY_CAP_MAX_XP_LEVEL = GROUP_XP_GENERAL.register(
            new Property.Binary("cap_max_xp_level", "Whether the player xp level should have a defined maximum or be unbound.", GROUP_XP_GENERAL, true)
    );
    ...
    public static final Property.Binary BINARY_ACCESSIBILITY_USE_PLAIN_BACKGROUND = GROUP_ACCESSIBILITY_ENCHANTING_TABLE.register(
    ...
    public static final Property.Binary BINARY_ACCESSIBILITY_OBFUSCATE_NEW_ENCHANTMENTS = GROUP_ACCESSIBILITY_ENCHANTING_TABLE.register(
    ...
    public static final Property.Binary BINARY_ACCESSIBILITY_OVERRIDE_ENCHANTMENT_NAME_COLOR = GROUP_ACCESSIBILITY_ENCHANTMENT_NAME.register(
    ...
    public static final Property.Color BOUNDED_ACCESSIBILITY_ENCHANTMENT_NAME_COLOR_VALUE = GROUP_ACCESSIBILITY_ENCHANTMENT_NAME.register(
            new Property.Color("enchantment_name_color_override_value", "The color value enchantment names should be override with.", GROUP_ACCESSIBILITY_ENCHANTMENT_NAME, 0xFFFFFF)
    );

    public static final Property.Binary BINARY_ACCESSIBILITY_OVERRIDE_ENCHANTMENT_LEVEL_COLOR = GROUP_ACCESSIBILITY_ENCHANTMENT_LEVEL.register(
    ...
    public static final Property.Color BOUNDED_ACCESSIBILITY_ENCHANTMENT_LEVEL_COLOR_VALUE = GROUP_ACCESSIBILITY_ENCHANTMENT_LEVEL.register(
            new Property.Color("enchantment_level_color_override_value", "The color value enchantment levels should be override with.", GROUP_ACCESSIBILITY_ENCHANTMENT_LEVEL, 0xFFFFFF)
    );
    ...
    public static final Property.Color BINARY_ENCHANTMENT_TOOLTIP_HEADER_COLOR_VALUE = GROUP_ACCESSIBILITY_ENCHANTMENT_TOOLTIP.register(
            new Property.Color("enchantment_level_color_override_value", "The color value enchantment tooltips headers should be overridden with.", GROUP_ACCESSIBILITY_ENCHANTMENT_TOOLTIP, 0xFFFFFF)
    );

    public static final Property.Color BOUNDED_ACCESSIBILITY_ENCHANTMENT_DESCRIPTION_COLOR = GROUP_ACCESSIBILITY_ENCHANTMENT_DESCRIPTION.register(
            new Property.Color("enchantment_description_color_value", "The color value enchantment descriptions should be override with.", GROUP_ACCESSIBILITY_ENCHANTMENT_DESCRIPTION, 0xA7A7A7)
    );
    // endregion
