...
public class Items {
    ...
    public static final DeferredHolder<Item, Item> DEACTIVATED_ENCHANTING_TABLE_ITEM =
            ITEMS.register("deactivated_enchanting_table", () -> new BlockItem(Blocks.DEACTIVATED_ENCHANTING_TABLE.get(), new Item.Properties()));

    public static final DeferredHolder<Item, Item> DISTURBED_ENCHANTING_TABLE_ITEM =
            ITEMS.register("disturbed_enchanting_table", () -> new BlockItem(Blocks.DISTURBED_ENCHANTING_TABLE.get(), new Item.Properties()));

    public static final DeferredHolder<Item, Item> ENCHANTED_TOME =
            ITEMS.register("enchanted_tome", () -> new EnchantedTomeItem(
                    new Item.Properties()
                            .stacksTo(1)
                            .rarity(Rarity.EPIC)
